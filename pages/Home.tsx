        ...
        <div className="flex-1 flex flex-col items-center justify-start z-10 w-full animate-slide-up">
            ...
            <div className="flex gap-8 mb-12 border-b border-slate-700 w-full max-w-xl justify-center">
                <button
                    ...
                    className={`pb-4 px-4 font-brand font-bold text-lg transition-all ${activeTab === 'play'
                ...
                <button
                    ...
                    className={`pb-4 px-4 font-brand font-bold text-lg transition-all ${activeTab === 'history'
                        ? 'text-indigo-400 border-b-2 border-indigo-400'
                        : 'text-slate-500 hover:text-slate-300'
                        }`}
                >
                                ...
                                <tbody className="divide-y divide-slate-700/50">
                                    {history.map((match) => (
                                        <tr key={match.id} className="hover:bg-slate-800/30 transition-colors">
                                            ...
                                            <td className="p-4">
                                                <span className={`px-2 py-1 rounded text-xs font-bold uppercase ${match.result === 'win' ? 'bg-emerald-900/50 text-emerald-400 border border-emerald-500/30' :
